...
import time
import numpy
from algorithm.DFS import dfs_and_generation_data, DFS
...
def create_frame(go_to, window, update_solver_path):
    ...
    def view():
        ...
        # 
        path, info, dataMap = dfs_and_generation_data(root)
