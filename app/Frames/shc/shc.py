...
import time
from algorithm.Greedy import greedy_and_generation_data, Greedy
...
def create_frame(go_to, window, update_solver_path):
    ...
    frame.button_2 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: greedy_solve_only(),
        relief="flat"
    )
    ...
    def greedy_solve_only():
        ...
        frame.text_1.insert("1.0", "Giải với Greedy-Best:\n")
    ...
    def view():
        ...
        start_time = time.perf_counter()
        # 
        path, info, dataMap = greedy_and_generation_data(root)
        # rs = Greedy(root)
        end_time = time.perf_counter()
        elapsed_time = end_time - start_time # Thời gian tính toán
